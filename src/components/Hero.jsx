      ...
      <div className="container relative" ref={parallaxRef}>
        ...
        <div className="relative bg-n-8 rounded-[1rem]">
          ...
          overflow-hidden md:aspect-[668/490] lg:aspect-[1024/490]" >
            ...
            width={1440} height={1800} alt="AI"/>
           
           <Generating className="absolute left-4 right-4
             bottom-5 md:left-1/2 md:right-auto md:buttom-8 md:w-[31rem]
             md:-translate-x-1/2"/>
        ...
        -translate-x-1/2 md:w-[138%] lg:-top-[34%]">
...
export default Hero; // Make sure to export the Hero component as the default export
